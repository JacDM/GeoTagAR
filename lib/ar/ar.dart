...
class FirebaseManager {
  ...
  void uploadAnchor(ARAnchor anchor, {Position? currentLocation}) {
    ...
    // Add the current location of the device to the anchor
  ...
  //write a function that downloads all anchors within a certain radius of the current location
  ...
  void downloadAnchorsByLocation(FirebaseDocumentStreamListener listener,
    ...
    Stream<List<DocumentSnapshot>> stream = geo!
        .collection(
            collectionRef: anchorCollection!)
