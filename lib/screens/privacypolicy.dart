          ...
          child: Padding(
            ...
            child: Column(
              children:   <Widget>[
                ...
                Text(
                   'GeoTagAR is committed to protecting the privacy of all users. Our privacy policy states how we process or use any of the personal data provided by you and keep it secure at the same time.'

'We may collect, store, and use the following kinds of personal information about individuals who decide to use GeoTagAR:'
...
'-    To administer our application - troubleshooting' 
...
'-    Any access request must be made in an email to (product email -> geotagar11@gmail.com) which shall be processed and provided within statutory time frames.'
...
'-    Any changes made to our privacy policy in the future shall be updated (and sent to you through our product email).'
...
'-    You can contact us at geotagar11@gmail.com',
                  style: TextStyle(
                      fontSize: 18.0,
